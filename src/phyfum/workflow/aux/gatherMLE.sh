...
[ $# -eq 0 ] || [ "$1" == "-h" ] || [ "$1" == "--help" ] && echo -e "$usage"
[ $# -lt 2 ] && echo -e "ERROR incorrect number of arguments: $usage"
...
EOF
	...
	resultContent=$(beast $tempFile) #ForPablo: if beast is not in the PATH we will need to change this
	rm -f $tempFile	
fi
